        ...
        <section className="card-container">
          <section>
            <section className="main-page-boxs">
             <Link to="/hybrids">
                <img className="main-hybrid-image" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTXahi8J7X1p9Vtp1gPPW1_Otr7-aT9zzDC2Mh_cbQdNO-LH3iO1ECeW-k81g-IiGWH8H0&usqp=CAU"/>   
                <h2>Hybrid</h2>
          ...
          <section  className="sativa-indica-container">
            <section className="main-page-boxs">
                <Link to="/sativas">
                  <img className="main-sativa-image" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTrn3bsFglsiR-s-Q2aoHpUMRG-OGKA3sWoZg&usqp=CAU"/> 
                  <h2>Sativa</h2>
                  <p>Combination Strains</p>
                </Link>
              </section>
